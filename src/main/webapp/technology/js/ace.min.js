...
!function (a) {
    ...
    ace.demo = {
        ...
        function b() {
            ...
            if ("fixed" == b.css("position")) {
                var d = parseInt(a(window).width()), e = d > 320 ? 60 : d > 240 ? 40 : 30,
                    f = parseInt(d) - e, g = parseInt(a(window).height()) - 30,
    ...
    if (c.length > 0) {
        ...
        a(window).on("scroll.scroll_btn", function () {
            var a = ace.helper.scrollTop(), b = ace.helper.winHeight(),
        ...
        this.force_reload = !1, this.loadUrl = function (a, b, c) {
            ...
            if (!j) {
                ...
                if (g.trigger(o = a.Event("ajaxloadstart"), {
                    ...
                    h.startLoading();
                    var p = "GET" == i ? {url: b, cache: !this.force_reload} : {
                        url: b,
                        method: "POST",
                        data: l
                    };
    ...
    function c(b, c) {
        ...
        var k = "menu-min", l = "responsive-min", m = "responsive-max", n = "h-sidebar",
            o = function () {
    ...
    function c(b, c) {
        ...
        function k(c) {
            ...
            g && (o = n, m.top += o);
            var t = parseInt(m.top + r), v = 0, y = u.height(), z = parseInt(m.top - k - o), A = y,
                B = q.horizontal, C = !1;
    ...
    if (!ace.vars.very_old_ie) {
        var d = ace.vars.touch, e = ace.vars.old_ie || d,
