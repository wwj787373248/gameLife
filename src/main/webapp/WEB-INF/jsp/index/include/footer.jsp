...
<footer class="footer-area section-gap">
    <div class="container">
        <div class="row">
            <div class="col-lg-5 col-md-18 col-sm-18">
                <div class="single-footer-widget">
                    <h4>About Me</h4>
                    <p>
                        A walk tortoise . manual cry =.=
                    </p>
                    <p class="footer-text"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        Copyright ©2020 Weijie Wu. All rights reserved. | <i class="fa fa-heart-o" aria-hidden="true"></i>Powered by Java on Weijie Wu <a href="http://www.beian.miit.gov.cn" target="_blank">浙ICP备19052485号-1</a>
